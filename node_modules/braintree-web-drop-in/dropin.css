...
.braintree-loader__indicator {
  ...
  position: relative;
  top: 50%;
  -webkit-transition: -webkit-transform 300ms cubic-bezier(0.43, 0.48, 0.62, 1.07);
  transition: -webkit-transform 300ms cubic-bezier(0.43, 0.48, 0.62, 1.07);
  transition: transform 300ms cubic-bezier(0.43, 0.48, 0.62, 1.07);
  transition: transform 300ms cubic-bezier(0.43, 0.48, 0.62, 1.07), -webkit-transform 300ms cubic-bezier(0.43, 0.48, 0.62, 1.07);
  width: 72px; }
  .braintree-loader__indicator:before {
    -webkit-animation: rotate 512ms infinite cubic-bezier(0.645, 0.045, 0.355, 1);
...
.braintree-sheet--loading .braintree-sheet__header::after {
  -webkit-animation: loader-scale 1s infinite, loader-origin 1s steps(1) infinite;
...
@-webkit-keyframes loader-origin {
  0% {
...
.braintree-method {
  ...
  padding: 14px 10px;
  position: relative;
  -webkit-transition: opacity 300ms, width 200ms cubic-bezier(0.175, 0.885, 0.32, 1.275), border-color 300ms, border-radius 300ms;
...
.braintree-loaded [data-braintree-id='sheet-container'] {
  max-height: 1000px;
  opacity: 1;
  -webkit-transition: max-height 250ms cubic-bezier(0.175, 0.885, 0.32, 1.275), opacity 300ms linear 100ms;
