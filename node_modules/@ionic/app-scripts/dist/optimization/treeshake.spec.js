...
describe('treeshake', function () {
    beforeEach(function () {
        ...
        env[Constants.ENV_ACTION_SHEET_VIEW_CONTROLLER_PATH] = path_1.join(env[Constants.ENV_VAR_IONIC_ANGULAR_DIR], 'components', 'action-sheet', 'action-sheet.js');
        ...
        env[Constants.ENV_ALERT_VIEW_CONTROLLER_PATH] = path_1.join(env[Constants.ENV_VAR_IONIC_ANGULAR_DIR], 'components', 'alert', 'alert.js');
        ...
        env[Constants.ENV_LOADING_VIEW_CONTROLLER_PATH] = path_1.join(env[Constants.ENV_VAR_IONIC_ANGULAR_DIR], 'components', 'loading', 'loading.js');
        ...
        env[Constants.ENV_MODAL_VIEW_CONTROLLER_PATH] = path_1.join(env[Constants.ENV_VAR_IONIC_ANGULAR_DIR], 'components', 'modal', 'modal.js');
        ...
        env[Constants.ENV_PICKER_VIEW_CONTROLLER_PATH] = path_1.join(env[Constants.ENV_VAR_IONIC_ANGULAR_DIR], 'components', 'picker', 'picker.js');
        ...
        env[Constants.ENV_POPOVER_VIEW_CONTROLLER_PATH] = path_1.join(env[Constants.ENV_VAR_IONIC_ANGULAR_DIR], 'components', 'popover', 'popover.js');
        ...
        env[Constants.ENV_TOAST_VIEW_CONTROLLER_PATH] = path_1.join(env[Constants.ENV_VAR_IONIC_ANGULAR_DIR], 'components', 'toast', 'toast.js');
        process.env = env;
    });
    afterEach(function () {
    ...
    describe('purgeUnusedImportsAndExportsFromModuleFile', function () {
        it('should remove the import and export statement', function () {
            ...
            var newContent = treeshake.purgeUnusedImportsAndExportsFromModuleFile(ionicAngularEntryPoint, moduleFileContent, modulesToPurge);
            // assert
    ...
    describe('purgeComponentNgFactoryImportAndUsage', function () {
        it('should purge the component factory import and usage from the file', function () {
            // arrange
            var knownImport = "import * as import29 from '../../node_modules/ionic-angular/components/action-sheet/action-sheet-component.ngfactory';";
            var knownImport2 = "import * as import30 from '../../node_modules/ionic-angular/components/alert/alert-component.ngfactory';";
            var knownImportUsage = "import29.ActionSheetCmpNgFactory,";
            var knownImportUsage2 = "import30.AlertCmpNgFactory,";
    ...
    describe('purgeProviderControllerImportAndUsage', function () {
        it('should purge the controller provider content', function () {
            ...
            var purgeGetterRegExOne = treeshake.generateRemoveGetterFromImportRegex(namedImportOne, '_ActionSheetController_46');
            ...
            var purgeGetterRegExTwo = treeshake.generateRemoveGetterFromImportRegex(namedImportTwo, '_AlertController_47');
